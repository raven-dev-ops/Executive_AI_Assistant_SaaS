...
def upgrade() -> None:
    ...
    if "businesses" not in existing_tables:
        op.create_table(
            ...
            sa.Column("reserve_mornings_for_emergencies", sa.Boolean(), nullable=False, server_default=sa.true()),
            ...
            sa.Column("retention_enabled", sa.Boolean(), nullable=True, server_default=sa.true()),
            ...
            sa.Column("integration_linkedin_status", sa.String(length=32), nullable=True),
            sa.Column("integration_gmail_status", sa.String(length=32), nullable=True),
            sa.Column("integration_gcalendar_status", sa.String(length=32), nullable=True),
            ...
            sa.Column("onboarding_completed", sa.Boolean(), nullable=True, server_default=sa.false()),
    ...
    if "customers" not in existing_tables:
        op.create_table(
            ...
            sa.Column("business_id", sa.String(), nullable=False),
            sa.Column("created_at", sa.DateTime(), nullable=False),
            sa.Column("sms_opt_out", sa.Boolean(), nullable=False, server_default=sa.false()),
    ...
    if "retention_purge_logs" not in existing_tables:
        op.create_table(
            ...
            sa.Column("appointments_deleted", sa.Integer(), nullable=False, server_default="0"),
            sa.Column("conversations_deleted", sa.Integer(), nullable=False, server_default="0"),
            sa.Column("conversation_messages_deleted", sa.Integer(), nullable=False, server_default="0"),
        )
        op.create_index("ix_retention_logs_created_at", "retention_purge_logs", ["created_at"])
